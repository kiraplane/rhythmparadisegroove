...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Rhythm Paradise Groove Wiki',
    description:
      'How Rhythm Paradise Groove Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#FFF8E8] py-12 text-[#201736]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#4B3E68]">
          Rhythm Paradise Groove Wiki uses essential cookies and similar
