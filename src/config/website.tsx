...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/rhythmparadisegroove/og-image.png',
      logoLight: '/logo.png',
      logoDark: '/logo.png',
    },
    social: {
      ...
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/watch?v=dIqElv-ewbg',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Rhythm Paradise Groove Wiki <hello@rhythmparadisegroove.wiki>',
    supportEmail: 'hello@rhythmparadisegroove.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
