...
export const CANONICAL_BASE_URL = 'https://www.rhythmparadisegroove.wiki';
...
function getRhythmParadiseGrooveBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'rhythmparadisegroove.wiki' ||
      parsedUrl.hostname === 'www.rhythmparadisegroove.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const rhythmParadiseGrooveBaseUrl =
    getRhythmParadiseGrooveBaseUrl(configuredBaseUrl);
  if (rhythmParadiseGrooveBaseUrl) {
    return rhythmParadiseGrooveBaseUrl;
  }
