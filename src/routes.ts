...
export enum Routes {
  ...
  MultiplayerAllMinigames = '/multiplayer/all-minigames',
  Beatspell = '/beatspell',
  BeatspellUnlock = '/beatspell/how-to-unlock',
  Walkthrough = '/walkthrough',
  Demo = '/demo',
  DemoMinigames = '/demo/minigames',
  DemoVsFullGame = '/demo/demo-vs-full-game',
  Setup = '/setup',
  SetupHandheldVsTv = '/setup/handheld-vs-tv',
  SetupBluetoothAudioLag = '/setup/bluetooth-audio-lag',
  Modes = '/modes',
  Release = '/release',
  Links = '/links',
