...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/codes(?:\/.*)?$/, target: '/guides/beginner-guide' },
  { pattern: /^\/tierlist\/?$/, target: '/minigames' },
  { pattern: /^\/tier-list\/?$/, target: '/minigames' },
  { pattern: /^\/packs(?:\/.*)?$/, target: '/minigames' },
  { pattern: /^\/cards(?:\/.*)?$/, target: '/minigames' },
  { pattern: /^\/mutations(?:\/.*)?$/, target: '/modes' },
  { pattern: /^\/download\/?$/, target: '/release' },
  { pattern: /^\/discord\/?$/, target: '/links' },
  { pattern: /^\/updates\/?$/, target: '/release' },
  { pattern: /^\/game-modes\/?$/, target: '/modes' },
  { pattern: /^\/calibration\/?$/, target: '/setup' },
  { pattern: /^\/input-lag\/?$/, target: '/guides/tv-calibration-input-lag' },
  { pattern: /^\/perfects?\/?$/, target: '/guides/perfect-solo-minigames' },
  {
    pattern: /^\/rhythm-heaven-groove\/?$/,
    target: '/guides/rhythm-heaven-vs-paradise-name',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'rhythmparadisegroove.wiki',
    'www.rhythmparadisegroove.wiki',
  ]);
